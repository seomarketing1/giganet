...
?>
        ...
        <p>Quando você pesquisa no Google e demais sites de busca, as repostas apresentadas vêm de um índice armazenado em seus servidores, e não da internet propriamente dita. Dessa forma, o seu site precisa estar indexado no Google, Yahoo, MSN, etc. A princípio, os sites de busca encontram automaticamente o seu site seguindo links que apontam para ele.  Para saber se o seu site faz parte do índice do Google, entre em google.com.br e digite site:<span class="destaque_faq_ana">www.O-SEU-SITE.com.br</span> (substitua pelo nome do seu site). Se o Google retornar algum resultado, significa que o site já está no índice, e você deve pular o passo seguinte.</p>
        <p>Caso o seu site seja novo ou não possua links apontados para ele, é necessário cadastrá-lo manualmente. O site para cadastro no Google é <span class="destaque_faq_ana">http://www.google.com/addurl/?continue=/addurl</span>.</p>
