...
?>
<div id="tutorial_ana_faq_content">
    <div class="tutorial_ana_faq_principal">
        <?php
include("../../includes/menu_tutorial_analytics.php");
?>
    	<h1>FAQ SEO<br/>Perguntas e Respostas Sobre SEO</h1>
        <p class="destaque_faq_ana">Respostas às perguntas e pesquisas mais frequentes relacionadas ao mundo de Search Engine Marketing</p>
        <p>Neste espaço procuramos responder as perguntas mais comuns para quem tem interesse em conhecer melhor o mundo de Search Engine Marketing, tanto para SEO (resultados naturais, orgânicos, Google, Yahoo, MSN) quanto de links patrocinados (Google Adwords, Yahoo Search Marketing). Tem uma dúvida? Pesquise as perguntas abaixo, veja o nosso tutorial Google, consulte o Glossário SEO ou faça a sua pergunta utilizando o formulário ao final desta página.</p>
        <ul id="ul_tutorial_ana">
        	<li><a href="como_aparecer_no_google.php" class="tut_faq_ana_link">Como aparecer no Google?</a></li>
            <li><a href="#" class="tut_faq_ana_link">Quanto tempo leva para o meu site aparecer no Google, Yahoo e MSN?</a></li>
            <li><a href="#" class="tut_faq_ana_link"> Como aparecer na primeira página das pesquisas do Google?</a></li>
            <li><a href="#" class="tut_faq_ana_link">Quais os requisitos básicos de um site para aparecer bem posicionado no Google?</a></li>
            <li><a href="#" class="tut_faq_ana_link">Penalidades Google - será que meu site foi penalizado?</a></li>
            <li><a href="#" class="tut_faq_ana_link">Qual o elemento de SEO mais importante?</a></li>
            <li><a href="#" class="tut_faq_ana_link">Como funciona o Google?</a></li>
            <li><a href="#" class="tut_faq_ana_link">Curso SEO ou consultoria? Escolha o melhor para você.</a></li>
            <li><a href="#" class="tut_faq_ana_link">Como remover um site do Google?</a></li>
        </ul>
...
<span class="destaque">Se interessou?</span></div>
    ...
    <div class="tutorial_ana_faq_secundario">
