...
<div id="quemsomos_content">
 <div class="quemsomos_principal">
  ...
  <div class="diretor">
   <div class="diretor_image"> <img src="<?php echo $dominio;?>imagens/schultze.jpg" alt="Benhard Schultze" /> </div>
   <div class="diretor_texto">
    ...
    <span class="destaque">Em 2006 fundou a SEO Marketing, uma das agências de marketing de busca pioneiras no Brasil com centenas de clientes já atendidos.</span> </div>
  </div>
  <div class="diretor">
   <div class="diretor_image"> <img src="<?php echo $dominio;?>imagens/dani.jpg" alt="Daniela Raketis" /> </div>
   <div class="diretor_texto">
    <h3>Daniela Fávero</h3>
    <p>Atual diretora da SEO Marketing, Daniela Fávero é formada em Comunicação Social com habilitação em Publicidade e Propaganda pela PUC-SP.</p>
    <p>Sua trajetória profissional teve início na própria agência, em maio de 2008, como analista de AdWords. Após um curto período nesta área, passou por três novas funções: Gerente de TOP Accounts, Social Media Manager e Gerente de Grandes Projetos.</p>
    ...
    <span class="destaque">Daniela Fávero é uma profissional extremamente focada em resultados, conhecendo o mundo das mídias sociais, ou Social Media, como poucos. </span> </div>
  </div>
