...
<title>Youtube para empresas | Agência SEO Marketing</title>
<meta name="description" content="Como sua marca pode utilizar um canal no YouTube e como a SEO Marketing pode torná-lo mais atraente para seus usuários reais e potenciais." />
<?php
...
<div id="sociais_content"  class="interna_content">
    ...
    <h1>Youtube para empresas</h1>
<h2 style="font-size:16px;">Criação de Canais</h2>

<p>O YouTube é uma excelente rede social para gerar conteúdo de qualidade e exclusivo, podendo atrair público de forma diferente e criativa. É importante para uma marca ter um canal no YouTube, pois se trata de um local onde é possível divulgar comerciais, making off, promoções, teste de produtos e informar os seus consumidores.</p>

<h3>Personalização</h3>

<p>O YouTube libera uma ferramenta para a personalização de um canal, porém quando se obtém uma aceitação do próprio YouTube, o nível de acesso na alteração de configuraçãos aumenta. Com o canal aceito pelo YouTube, a empresa se torna parceira, sendo assim, você pode torn´-lo mais profissional e ainda ter o poder de monetizá-lo, gerando lucros  com anúncios e divulgação.</p>
