...
<title>Monitoramento e SAC Online | Agência SEO Marketing</title>
<meta name="description" content="Monitorar o que falam sobre a sua marca nas redes sociais é um passo muito importante em sua estratégia de marketing digital. Saiba o que a SEO Marketing pode fazer por você." />
<?php
...
<div id="sociais_content"  class="interna_content">
    ...
    <h1>Monitoramento e SAC Online</h1>
	<p>O consumidor está cada vez mais exigente, informado e conectado à internet. Deixar de ouvir o que ele fala sobre a sua marca nas redes sociais é ignorar estratégias para melhorar seu atendimento, seus serviços e, claro, de demonstrar o quanto você está empenhado em melhorar os pontos negativos e aperfeiçoar o que é elogiado. Dessa forma, a SEO Marketing considera esta uma ferramenta fundamental no trabalho feito nas redes sociais. São nossos diferenciais no atendimento ao SAC online:</p>
    <ul>
        <li>Agilidade nas respostas</li>
        <li>Conexão com o SAC da empresa, facilitando e unificando o diálogo com o consumidor</li>
        <li>Linguagem adequada ao público-alvo</li>
        <li>Humanização do SAC, buscando sempre ouvir e atender à necessidade do consumidor</li>
        <li>Moderação de comentários, de acordo com o seu teor.</li>
    </ul>
