...
<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">Como o Google exibe seus resultados?</span>
			</div>
		</div>
...
<p>Resumindo, o <strong>índice de sites de busca</strong> representa conteúdo da internet armazenado em seus servidores e indexado de forma a oferecer respostas precisas e extremamente velozes às consultas realizadas.</p>
        ...
        <a href="<?php echo $dominio;?>tutorial-seo/importancia-titulos-seo/" class="tutorial_seo_prox_topico">
        <span class="prox_topico_peq">Próximo Tópico</span>
        <span class="prox_topico_grande">A Importância dos Títulos para SEO</span>
        </a>
