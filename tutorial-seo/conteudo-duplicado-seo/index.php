...
<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">Conteúdo Duplicado</span>
			</div>
		</div>
        ...
        <a href="<?php echo $dominio;?>tutorial-seo/densidade-keywords-web-writing/" class="tutorial_seo_prox_topico">
        <span class="prox_topico_peq">Próximo Tópico</span>
        <span class="prox_topico_grande">Densidade das Keywords e Web Writing</span>
        </a>
