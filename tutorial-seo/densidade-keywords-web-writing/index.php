...
<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">Densidade de Keywords e Web Writing</span>
			</div>
		</div>
        ...
        <a href="<?php echo $dominio;?>tutorial-seo/heading-tags/" class="tutorial_seo_prox_topico">
        <span class="prox_topico_peq">Próximo Tópico</span>
        <span class="prox_topico_grande">Heading Tags - Hierarquização do Conteúdo</span>
        </a>
