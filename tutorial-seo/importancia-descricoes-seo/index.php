...
<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">A Importância das Descrições para SEO</span>
			</div>
		</div>
...
<p>Outra dica é fazer pequenos testes com intervalos de aproximadamente 1 mês ou um pouco menos. Os períodos devem ser espaçados, pois o Google leva um certo tempo para indexar o conteúdo e alterações muito frequentes podem atrapalhar o posicionamento.</p>
        ...
        <a href="<?php echo $dominio;?>tutorial-seo/conteudo-duplicado-seo/" class="tutorial_seo_prox_topico">
        <span class="prox_topico_peq">Próximo Tópico</span>
        <span class="prox_topico_grande">Conteúdo Duplicado e SEO</span>
        </a>
