...
if(!empty($_POST['contato_rapido_email'])){$email = $_POST['contato_rapido_email'];}

if(!empty($_POST['contato_rapido_mensagen'])){$mensagem = $_POST['contato_rapido_mensagen'];}
...
mail($destinatario, "Mensagem de Contato",$corpo, $headers) or die('erro');
