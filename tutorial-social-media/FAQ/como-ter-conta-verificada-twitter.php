...
<title>Como ter uma conta verificada no Twitter? | Agência SEO Marketing</title>
...
?>
		...
		<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">Como posso ter uma conta verificada no Twitter?</span>
			</div>
		</div>

    	<h1><small>FAQ Social Media</small><br/>Como posso ter uma conta verificada no Twitter?</h1>
    
    <p>A verified account é uma forma do Twitter de identificar a autenticiadade de um perfil evitando que usuários confudam personalidades com fakes.</p>
	
	<p>O Twitter não aceita pedidos de verificação do público em geral. Ele privilegia as pessoas com grande influência na música, moda, atuação, política, religião, jornalismo, mídia, publicidade e outras áreas.</p>
