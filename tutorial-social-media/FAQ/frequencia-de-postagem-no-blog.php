...
<title>Quantas vezes por semana devo postar no meu blog? | Agência SEO Marketing</title>
...
?>
		...
		<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">Quantas vezes por semana devo postar no meu blog?</span>
			</div>
		</div>

    	<h1><small>FAQ Social Media</small><br/>Quantas vezes por semana devo postar no meu blog?</h1>
    
    <p>Geralmente um blog é atualizado diariamente, no entanto, isso não é regra. Há determinados nichos e assuntos que não necessitam de tal frequencia. Também não é interessante que o blog tenha posts todos os dias quando eles não estejam sendo feitos com qualidade. O ideal é que haja no mínimo de dois a três posts por semana, primando pela qualidade.</p>
