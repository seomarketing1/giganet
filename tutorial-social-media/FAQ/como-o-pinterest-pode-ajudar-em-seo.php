...
<title>Como o Pinterest pode ajudar em SEO? | Agência SEO Marketing</title>
...
?>
		...
		<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">Como o Pinterest pode ajudar em SEO?</span>
			</div>
		</div>

    	<h1><small>FAQ Social Media</small><br/>Como o Pinterest pode ajudar em SEO?</h1>
    
    <p>O Pinterest ultrapassou o Google e o Twitter como fonte de tráfego de referência. Isso se deve ao fato de que cada vez que uma imagem é “pinada” a um board, um link aponta para a fonte original da publicação, gerando backlinks. Por conta disso essa rede social pode ser uma opção para complementar suas estratégias de Link Building.</p>
