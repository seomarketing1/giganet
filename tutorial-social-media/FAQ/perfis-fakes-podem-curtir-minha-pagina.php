...
<title>Se eu investir em Facebook Ads, perfis fakes irão curtir minha página? | Agência SEO Marketing</title>
...
?>
		...
		<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">Se eu investir em Facebook Ads, perfis fakes irão curtir minha página?</span>
			</div>
		</div>

    	<h1><small>FAQ Social Media</small><br/>Se eu investir em Facebook Ads, perfis fakes irão curtir minha página?</h1>
    
    <p>A verdade é que, em qualquer rede social, sempre haverá perfis fake. O perfil fake é um perfil com características genéricas e por isso quando as campanhas de Facebook Ads são segmentadas com qualidade, as chances de atrair esse tipo de perfil <a href='http://blog.seomarketing.com.br/2012/08/facebook-ads-e-fakes-para-onde-esta_844.html' target='_blank'>são praticamente nulas</a>.</p>

	<p>O Facebook Ads requer trabalho constante de “targeting” e “retargeting”, para que as campanhas estejam sempre de acordo para atingir o público-alvo. Criar um anúncio e deixá-lo rodando para sempre, sem que a campanha tenha um acompanhamento sobre seu desempenho, não gerará bons resultados.</p>
