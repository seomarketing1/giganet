...
<title>Por que minha empresa deve ter um blog corporativo? | Agência SEO Marketing</title>
...
?>
		...
		<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">Por que minha empresa deve ter um blog corporativo?</span>
			</div>
		</div>

    	<h1><small>FAQ Social Media</small><br/>Por que minha empresa deve ter um blog corporativo?</h1>
    
    <p>Ter esse tipo de comunicação é muito importante para manter uma relação forte em você e seu cliente. Divulgando novidades, produtos, opiniões sobre o mercado de atuação mostra ao consumidor que sua empresa está atualizada e inserida nos assuntos mais relevantes para o seu cliente e para a própria empresa.</p>
