...
<title>Como posso aumentar minha pontuação no Klout? | Agência SEO Marketing</title>
...
?>
		...
		<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">Como posso aumentar minha pontuação no Klout?</span>
			</div>
		</div>

    	<h1><small>FAQ Social Media</small><br/>Como posso aumentar minha pontuação no Klout?</h1>
    
    <p>No Klout são levados em consideração os seguintes tipos de interação para aumentar o índice:</p>

	<ul>
	<li>Facebook: Menções ao seu perfil através de tags, Curtirs, Número de Assinantes, Posts no seu mural, Número de amigos;</li>
	<li>Twitter: Retweets, Mentions, Listas que você está, Replies, Número de followers;</li>
	<li>Google+: Comentários no seu conteúdo, +1s, Compartilhamento do seu conteúdo;</li>
	<li>LinkedIn: Título do seu cargo no LinkedIn, Suas Conexões, Recomendações, Comentários;</li>
	<li>Foursquare: Tips feitas – O número de sugestões que você deixou como tip em venues que as pessoas, de fato, completaram;</li>
	<li>+K: +K recebidos de seus amigos;</li>
	</ul>

	<p>Mas, lembre-se, que o algorítmo atualliza-se com frequência e que eles estão atentos à qualidade e não à quantidade da interação.</p>
