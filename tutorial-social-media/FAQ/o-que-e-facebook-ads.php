...
<title>O que é Facebook Ads? | Agência SEO Marketing</title>
...
?>
		...
		<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">O que é Facebook Ads?</span>
			</div>
		</div>

    	<h1><small>FAQ Social Media</small><br/>O que é Facebook Ads?</h1>
    
    <p>O <a href='http://blog.seomarketing.com.br/2012/10/facebook-ads.html' target='_blank'>Facebook Ads</a> é a ferramenta de publicidade do Facebook que permite divulgar anúncios de diversos formatos.</p>

	<p>Há a possibilidade de segmentar cada anúncio de acordo com o perfil do usuário, seja por sua localização, sexo, faixa etária ou interesses, com muito mais chances de alcançar aquelas pessoas que possam adquirir, curtir ou apenas comentar seus produtos/serviços.</p>
