...
<title>O que é Klout? | Agência SEO Marketing</title>
...
?>
		...
		<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">O que é Klout?</span>
			</div>
		</div>

    	<h1><small>FAQ Social Media</small><br/>O que é Klout?</h1>
    
    <p>O Klout é um índice de influência social. Ele é calculado através de um algorítmo, que estabelece uma “nota” de 0 a 100 para você, baseando-se em vários tipos de interações dos seus perfis sociais.</p>
