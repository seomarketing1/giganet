...
<title>O que é Facebook Marketing? | Agência SEO Marketing</title>
...
?>
		...
		<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">O que é Facebook Marketing?</span>
			</div>
		</div>

    	<h1><small>FAQ Social Media</small><br/>O que é Facebook Marketing?</h1>
    
    <p>É o conjunto das estratégias de marketing aplicadas à presença de determinada empresa no Facebook para levar informações relevantes ao seu público-alvo, de forma que isso se reverta em resultados positivos de branding e vendas, de acordo com o objetivo e escopo de cada empresa.</p>
