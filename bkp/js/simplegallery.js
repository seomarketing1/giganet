...
var simpleGallery_navpanel={
	loadinggif: 'imagens/load.gif', //full path or URL to loading gif image
	panel: {height:'25px', opacity:0.5, paddingTop:'5px', fontStyle:'bold 11px Verdana'}, //customize nav panel container
	images: [ 'imagens/LEFT.png', 'play.gif', 'imagens/RIGHT.png', 'pause.gif'], //nav panel images (in that order)
...
simpleGallery.routines={
	...
	addnavpanel:function(setting){
		...
		$('<div class="navpanelbg"></div><div class="navpanelfg"></div>') //create inner nav panel DIVs
			...
			.eq(0).css({background:'#32b9eb', opacity:simpleGallery_navpanel.panel.opacity}).end() //"navpanelbg" div
	...
	adddescpanel:function(setting){
		setting.$descpanel=$('<div class="gallerydesc"><div class="gallerydescbg"></div><div class="gallerydescfg"><div class="gallerydesctext"></div></div></div>')
			...
			.eq(0).css({background:'#32b9eb', opacity:simpleGallery_navpanel.panel.opacity}).end() //"gallerydescbg" div
