...
<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">Resultados Naturais ou Orgânicos</span>
			</div>
		</div>
...
<a href="<?php echo $dominio;?>tutorial-seo" class="tutorial_seo_prox_topico">
    <span class="prox_topico_peq">Voltar ao Primeiro Tópico</span>
    <span class="prox_topico_grande">Início do Tutotial SEO</span>
    </a>
