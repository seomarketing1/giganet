...
<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">Meta Tags e sua importância para SEO</span>
			</div>
		</div>
...
<ul>
  <li><strong>index</strong>: indexe esta página - exiba-a em seus resultados de busca;</li>
	...
	<a href="<?php echo $dominio;?>tutorial-seo/page-rank" class="tutorial_seo_prox_topico">
    <span class="prox_topico_peq">Próximo Tópico</span>
    <span class="prox_topico_grande">O que é o Page Rank</span>
    </a>
