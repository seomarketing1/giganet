...
<ul>
  ...
  <li> Verifique se h&aacute; um arquivo robots.txt na raiz do seu site.<br />



    <strong>EX: </strong>http://www.meusite.com.br/robots.txt</li>

  <li> Crie o arquivo robots.txt ou modifique o conte&uacute;do para que seja:<br />
  ...
  <li>V&aacute; at&eacute; a interface do <a href="http://www.google.com/webmasters/tools/" target="_blank">Google Webmaster Tools</a>&nbsp; e fa&ccedil;a a solicita&ccedil;&atilde;o de exclus&atilde;o do site em:</li><br />



  <ul>

    <li><strong>Ferramentas</strong> &gt; <strong>Remover URLs</strong><br />

    <br />

    <img src="http://www.seomarketing.com.br/imagens/remover-site-1.jpg" alt="remover site do google - 1"  /></li><br /><br />



    <li><strong>Novo Pedido de Remo&ccedil;&atilde;o</strong><br />

    <br />

    <img src="http://www.seomarketing.com.br/imagens/remover-site-2.jpg" alt="remover site do google 3" width="400" height="165" /><br /></li>
    ...
    <li><strong>Marque a op&ccedil;&atilde;o &quot;O seu  site inteiro&quot;<br />

    <br />

    <img src="http://www.seomarketing.com.br/imagens/remover-site-3.jpg" alt="remover site do google 3" width="190" height="220" /></strong></li>

    <br />

    <br />

  <li><strong>Confirme</strong><br />

  <br />

  <img src="http://www.seomarketing.com.br/imagens/remover-site-4.jpg" alt="remover site do google 4" width="400" height="234" /><br /></li>
