    <div class="quemsomos_secundario">
        <div class="secundario_atencao">
            <div class="atencao_titulo">Equipe</div>
            <div class="atencao_descritivo_titulo">A EQUIPE<br/>SEO MARKETING</div>
            <div id="equipe"></div>
        </div>
        <div class="secundario_atencaob">
            <div class="atencao_titulo">Missão</div>
            <div class="atencao_descritivo_titulo">A EQUIPE<br/>SEO MARKETING</div>
            <div class="atencao_descritivo_texto">A SEO marketing é um empresa de consultoria 100% focada em marketing para sites de busca como o Google. Ajudamos empresas e prestadores de serviços a utilizarem os </div>
        </div>
        ...
        <div class="fb-like-box" data-href="http://www.facebook.com/SEOMarketingBR" data-width="320" data-height="370" data-show-faces="true" data-stream="false" data-header="true"></div></div>
    </div>
</div>
