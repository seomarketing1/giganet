...
<title>Como divulgar minha Fanpage? | Agência SEO Marketing</title>
...
?>
		...
		<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">Como divulgar minha Fanpage?</span>
			</div>
		</div>

    	<h1><small>FAQ Social Media</small><br/>Como divulgar minha Fanpage?</h1>
	
    <p>O conteúdo de qualidade é a base para a divulgação de uma página. É ele que faz o usuário curtir, comentar, compartilhar, comprar...</p>

	<p>Além disso, ter contato com formadores de opinião sobre o assunto que você está tratando é bem interessante.</p>

	<p>Anunciar por meio do Facebook Ads também é excelente para você divulgar sua página. No entanto, se o usuário chegar a ela e ver um conteúdo de baixa qualidade e desinteressante, ele dificilmente irá interagir de forma positiva. Por isso, pense bem, pois não adianta apenas fazer anúncios. A construção de uma estratégia à parte disso é o passo número um.</p>
