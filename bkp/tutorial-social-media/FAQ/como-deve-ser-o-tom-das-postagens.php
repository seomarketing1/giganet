...
<title>Como deve ser o tom das postagens? | Agência SEO Marketing</title>
...
?>
		...
		<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">Como deve ser o tom utilizado em minhas postagens</span>
			</div>
		</div>

    	<h1><small>FAQ Social Media</small><br/>Como deve ser o "tom" utilizado em minhas postagens?</h1>
    
    <p>O tipo de abordagem feito por sua empresa nas mídias sociais deve ser definido de acordo com a estratégia que sua marca pretende aplicar nestes canais. Você pode tornar os perfis da empresa amigos de seus usuários e usar um tom de comunicação mais leve e semelhante ao usado por eles, ou até mesmo, seguir uma linha mais empresarial e conservadora. </p>
