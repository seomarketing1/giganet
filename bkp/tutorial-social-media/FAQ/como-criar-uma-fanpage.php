...
<title>Como criar uma Fanpage | Agência SEO Marketing</title>
...
?>
		...
		<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">Como criar uma fanpage</span>
			</div>
		</div>

    	<h1><small>FAQ Social Media</small><br/>Como criar uma fanpage?</h1>
    
    <p>Para criar uma Fan Page, acesse o link: <a href="http://www.facebook.com/pages/browser.php">http://www.facebook.com/pages/browser.php</a> e clique em "Criar Página". Depois, é só seguir os passos, completando as informações de acordo com a sua empresa.</p>
