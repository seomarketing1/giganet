...
<title>O que são os Círculos no Google+? | Agência SEO Marketing</title>
...
?>
		...
		<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">O que são os Círculos no Google+?</span>
			</div>
		</div>

    	<h1><small>FAQ Social Media</small><br/>O que são os Círculos no Google+?</h1>
    
    <p>Os Círculos permitem que você organize seus seguidores em categorias, como por exemplo, “Amigos Pessoais”, “Colegas de Trabalho”, “Empresas”. Dessa forma, é possível segmentar o conteúdo que você compartilha.</p>

	<p>Para as empresas é importante classificar os novos seguidores de sua página, segundo o seu perfil, idade, sexo, localização, etc. Assim, suas postagens podem ser exclusivas para certos círculos. Isso aumenta a sua chance de interação.</p>
