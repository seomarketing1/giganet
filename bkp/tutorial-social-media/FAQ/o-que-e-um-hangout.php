...
<title>O que é um Hangout? | Agência SEO Marketing</title>
...
?>
		...
		<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">O que é um Hangout?</span>
			</div>
		</div>

    	<h1><small>FAQ Social Media</small><br/>O que é um Hangout?</h1>
    
    <p>É uma ferramenta do Google+ para realizar vídeo-conferências de forma gratuita. Você cria o Hangout, define quais círculos vão ter acesso e depois é enviado um convite aos participantes perguntando se eles querem ou não assistir. Ele também pode ser feito em modalidade broadcast, que é o chamado Hangout On Air.</p>
