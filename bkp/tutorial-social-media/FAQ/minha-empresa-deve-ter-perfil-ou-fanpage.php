...
<title>Minha empresa deve ter Perfil ou Fanpage | Agência SEO Marketing</title>
...
?>
		...
		<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">Minha empresa deve ter um perfil ou fanpage?</span>
			</div>
		</div>

    <h1><small>FAQ Social Media</small><br/>Minha empresa deve ter um perfil ou uma fanpage?</h1>
    
    <p>De acordo com os termos de serviço do Facebook, cada pessoa pode ter um perfil com exclusivo caráter pessoal. Qualquer empresa que tenha um perfil que quebre esses termos, tem a possibilidade dele ser excluído a qualquer momento.</p>

	<p>A Fan Page também oferece diversos recursos a mais que o perfil, pois não há limite de fãs, permite a customização, o uso de aplicativos e a análise de dados com o Facebook Insights.</p>
