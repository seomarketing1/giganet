...
<title>Para que serve o botão +1? | Agência SEO Marketing</title>
...
?>
		...
		<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">Para que serve o botão +1?</span>
			</div>
		</div>

    	<h1><small>FAQ Social Media</small><br/>Para que serve o botão +1?</h1>
    
    <p>O botão +1 do Google+ é semelhante ao botão "Curtir" do Facebook. Para utilizá-lo, basta ter um perfil no Google. Ele permite recomendar páginas publicamente na web e compartilhar com seus círculos, caso você tenha perfil na rede social.</p>
