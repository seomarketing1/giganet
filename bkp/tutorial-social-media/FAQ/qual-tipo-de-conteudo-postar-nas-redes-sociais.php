...
<title>Qual tipo de conteúdo postar nas Redes Sociais? | Agência SEO Marketing</title>
...
?>
		...
		<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">Qual tipo de conteúdo postar nas redes sociais</span>
			</div>
		</div>

    	<h1><small>FAQ Social Media</small><br/>Qual tipo de conteúdo devo postar em minhas redes sociais?</h1>
    
    <p>Sua estratégia, definidas em conjunto com a equipe de Social Media da agência, é que vai definir isso. Muitas vezes, as postagens com objetivo de interação são as que apresentam maior buzz, já que torna viva a conversa com seus usuários. No entanto, é importante não se prender a apenas isso. Procure também conversar com seu público-alvo sobre a área em que a empresa atua, por exemplo. Se as informações forem boas, as chances de falarem e compartilharem a sua marca, são maiores.</p>
