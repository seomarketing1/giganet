...
<title>Como o Foursquare pode ajudar meu negócio local? | Agência SEO Marketing</title>
...
?>
		...
		<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">Como o Foursquare pode ajudar meu negócio?</span>
			</div>
		</div>

    	<h1><small>FAQ Social Media</small><br/>Como o Foursquare pode ajudar meu negócio local?</h1>
    
    <p>O número de usuários de smatphones no Brasil está crescendo a cada dia. E o dinamismo proporcionado pela integração entre on e off, torna-se palpável para o consumidor no local físico através do Foursquare. Ele desperta a curiosidade dos clientes e traz um <a href='http://blog.seomarketing.com.br/2012/09/solomo-o-novo-conceito-social-media.html' target='_blank'>gostinho de inovação</a> a qualquer estabelecimento.</p>

	<p>Além de poder fazer promoções, através das Specials, com os dados analíticos fornecidos você consegue saber quem é o público que frequenta o seu estabelecimento.</p>
