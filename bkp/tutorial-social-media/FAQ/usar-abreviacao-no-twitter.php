...
<title>Usar abreviação no Twitter? | Agência SEO Marketing</title>
...
?>
		...
		<div class="breadcrumb">
			...
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			    <span itemprop="title">Minha empresa deve utilizar palavras abreviadas no Twitter?</span>
			</div>
		</div>

    <h1><small>FAQ Social Media</small><br/>Minha empresa deve utilizar palavras abreviadas no Twitter?</h1>
    
    <p>Com o limite de 140 caracteres por post no Twitter, o uso de abreviações ajuda muito. Claro que não se deve abreviar todas as palavras, deixando este recurso apenas para as mais simples e que já tenham uma forma abreviada mais conhecida, como: hj, vc, tbm.</p>
